...
MibIdentifier, IpAddress, ModuleIdentity, Unsigned32, TimeTicks, mib_2, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Counter32, Counter64, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "ModuleIdentity", "Unsigned32", "TimeTicks", "mib-2", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Counter32", "Counter64", "Integer32", "Gauge32")
TestAndIncr, TruthValue, TimeStamp, AutonomousType, PhysAddress, DisplayString, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "TimeStamp", "AutonomousType", "PhysAddress", "DisplayString", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifMtu=ifMtu, ifTable=ifTable, ifStackTable=ifStackTable, ifXTable=ifXTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestCode=ifTestCode, ifTestEntry=ifTestEntry, ifTestTable=ifTestTable, ifInUnknownProtos=ifInUnknownProtos, PYSNMP_MODULE_ID=ifMIB, ifIndex=ifIndex, ifInOctets=ifInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifOutDiscards=ifOutDiscards, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifConformance=ifConformance, ifTestType=ifTestType, ifAlias=ifAlias, ifGroups=ifGroups, ifTestOwner=ifTestOwner, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInUcastPkts=ifInUcastPkts, interfaces=interfaces, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliances=ifCompliances, ifOutErrors=ifOutErrors, ifOutOctets=ifOutOctets, ifXEntry=ifXEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndex=InterfaceIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance2=ifCompliance2, ifStackStatus=ifStackStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifLastChange=ifLastChange, ifOperStatus=ifOperStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifConnectorPresent=ifConnectorPresent, ifTestId=ifTestId, ifHighSpeed=ifHighSpeed, ifTableLastChange=ifTableLastChange, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, OwnerString=OwnerString, ifSpecific=ifSpecific, ifPhysAddress=ifPhysAddress, ifMIBObjects=ifMIBObjects, ifMIB=ifMIB, ifTestResult=ifTestResult, ifFixedLengthGroup=ifFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifCompliance3=ifCompliance3, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressTable=ifRcvAddressTable, ifStackLastChange=ifStackLastChange, ifEntry=ifEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifStackGroup2=ifStackGroup2, ifDescr=ifDescr, ifInDiscards=ifInDiscards, ifHCOutOctets=ifHCOutOctets, ifNumber=ifNumber, linkUp=linkUp, ifStackGroup=ifStackGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPacketGroup=ifPacketGroup, ifName=ifName, ifStackEntry=ifStackEntry, ifOutQLen=ifOutQLen, ifInErrors=ifInErrors, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackHigherLayer=ifStackHigherLayer, ifTestStatus=ifTestStatus, ifHCInOctets=ifHCInOctets, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressAddress=ifRcvAddressAddress, ifTestGroup=ifTestGroup, ifSpeed=ifSpeed, ifType=ifType, ifCompliance=ifCompliance, linkDown=linkDown, ifGeneralGroup=ifGeneralGroup, ifRcvAddressStatus=ifRcvAddressStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInNUcastPkts=ifInNUcastPkts)
