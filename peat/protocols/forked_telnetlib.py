r"""
===== PEAT FORK NOTES =====
PEAT's fork of CPython's telnetlib.py
Forked from commit 8e3bd342f39d9904ee48065446562db3f1d66e61 in CPython (CPython 3.12).
Link: https://github.com/python/cpython/blob/8e3bd342f39d9904ee48065446562db3f1d66e61/Lib/telnetlib.py

Fork created on November 11th, 2024, to maintain compatibility with Python 3.13+, due
to PEP 594's removal of telnetlib from the standard library. Eventually, this will be
cleaned up to match the code standards for PEAT, or replaced with a more suitable
third-party package. In the short term, the priority is maintaining current compatibility
with the devices PEAT is known to work with over Telnet.

Changes made to the original code:

- Removed test() function and __main__ entrypoint
- Removed calls to sys.audit()
- Removed interact(), mt_interact(), and listener()
- Replace msg() and print() with PEAT's logging utilities
- Removed set_debuglevel(), debuglevel, and msg()
...
class Telnet:
    ...
    def __init__(self, host=None, port=0,
        ...
        # NOTE: these messages are written to logs/telnet.log
        # This sink is configured in log_utils.setup_logging()
        self.log = log.bind(
                ...
                if not self.iacseq:
                    ...
                    if c == IAC:
                        ...
                        if self.option_callback:
                            ...
                            self.log.trace('IAC %d not recognized' % ord(c))
